      ...
      try {
        ...
        if (providerAttempt < MAX_PROVIDER_ATTEMPTS) {
          ...
          try {
            ...
            logger.info({ gatewayRequestId, newProvider: newRouting.providerId, attempt: providerAttempt }, "Failover to new streaming provider");
            continue;
          } catch (routeError) {
    ...
    try {
      ...
      await logRequest({
        ...
        gatewayRequestId,
          ...
          modelId = newRouting.modelId;
          modelFamily = newRouting.modelFamily;
          logger.info({ gatewayRequestId, newProvider: newRouting.providerId, attempt: providerAttempt }, "Failover to new provider");
